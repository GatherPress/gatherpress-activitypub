...
define( 'GATHERPRESS_ACTIVITYPUB_PATH', __DIR__ );
define( 'GATHERPRESS_ACTIVITYPUB_FILE', __FILE__ );
...
function gatherpress_activitypub_autoloader( array $namespaces ): array {
	$namespaces['GatherPress_ActivityPub'] = GATHERPRESS_ACTIVITYPUB_PATH;
...
function gatherpress_activitypub_setup(): void {
	if ( defined( 'GATHERPRESS_VERSION' ) && defined( 'ACTIVITYPUB_PLUGIN_VERSION' ) && class_exists( 'GatherPress_ActivityPub\Setup' ) ) {
